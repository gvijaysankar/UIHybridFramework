...
public class StudentCompleteAllDataTest {
	private static Logger LOGGER = Logger.getLogger(StudentCompleteAllDataTest.class);
	String className = this.getClass().getName();
	ArrayList<Map<String, String>> validationresults = new ArrayList<Map<String, String>>();
	/*
	 * String mobileNumber = System.getProperty("mobileNumber"); String email =
	 * System.getProperty("email"); String password =
	 * System.getProperty("password"); String ldapID = System.getProperty("LDAPID");
				...
				try {
					...
					if (stud_home.clickProfileSettingLink()) {
						...
						if (stud_profile_settings.clickEditContactDetailsLink()) {
							...
							dataMap.put("TestResult", "FAIL");
							dataMap.put("EDIT_CONTACT_DETAILS",
									"FAIL-Unable to edit Contact Details,as use unable to Navigate to Edit Contacts Page");
